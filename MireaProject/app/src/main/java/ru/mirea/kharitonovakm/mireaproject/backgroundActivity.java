...
public class backgroundActivity extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Constraints constraints = new Constraints.Builder()
                ...
                .build();
        WorkRequest request = new OneTimeWorkRequest.Builder(PsychoDailyWorker.class)
                .setConstraints(constraints)
                .build();
        WorkManager.getInstance(requireContext()).enqueue(request);

        String dailyTip = requireContext().getSharedPreferences("PsychoTips", Context.MODE_PRIVATE)
                .getString("DailyTip", "Загрузка совета...");
        TextView TipTextView = view.findViewById(R.id.textView9);
