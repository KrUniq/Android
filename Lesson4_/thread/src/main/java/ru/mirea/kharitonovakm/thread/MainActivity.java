package ru.mirea.kharitonovakm.thread;
...
import ru.mirea.kharitonovakm.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: 04, НОМЕР ПО СПИСКУ: 29, МОЙ ЛЮБИИМЫЙ ФИЛЬМ: Барби");
    ...
    public void OnStartBlockingCalculationInBackgroundThreadButtonPressed(View v) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Log.d("ThreadProject", String.format("Запущен поток № %d студентом группы № %s номер по списку № %d ", numberThread, "БСБО-04-22", 29));
